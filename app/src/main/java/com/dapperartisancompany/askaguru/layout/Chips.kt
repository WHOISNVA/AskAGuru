...
//        it.toString().replaceFirstChar { c -> c.uppercase() }
//    },
//) {
//    val scrollState = rememberLazyListState()
//    val firstSelectedIndex =
//        if (selectedItems.isEmpty()) null else items.indexOf(selectedItems.first())
//    LaunchedEffect(firstSelectedIndex) {
//        if (firstSelectedIndex != null)
//            scrollState.animateScrollToItem(firstSelectedIndex)
//    }
//    LazyRow(
//        horizontalArrangement = Arrangement.spacedBy(Theme.specs.paddingSmall),
//        state = scrollState,
